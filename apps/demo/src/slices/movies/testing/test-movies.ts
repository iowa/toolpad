import type { GenresRepository } from "@/slices/genres/services/genres-repository";
import type { GenreInsert } from "@/slices/genres/types";
import type { MoviesRepository } from "@/slices/movies/services/movies-repository";
import type { MovieInsert } from "@/slices/movies/types";
...
export class TestMovies {
  ...
  readonly genresRepository: GenresRepository;
