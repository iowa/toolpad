import type { MovieList, MovieInsert, MovieSearchParams, Movie } from "@/entities/movie/model/types";
import { genresTable, moviesGenresTable, moviesTable } from "@/shared/lib/db";
import { eq, gte, inArray, like, lte, sql } from "drizzle-orm";
import type { DrizzleClient } from "@/shared/lib/db-connection";
